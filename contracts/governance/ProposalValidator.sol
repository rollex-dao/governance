...
/**
 * @title Proposal Validator Contract, inherited by  Pegasys Governance Executors
...
contract ProposalValidator is IProposalValidator {
   ...
   **/
  function getMinimumPropositionPowerNeeded(IPegasysGovernanceV2 governance, uint256 blockNumber)
    public
    view
    override
    returns (uint256)
   ...
   **/
  function isProposalPassed(IPegasysGovernanceV2 governance, uint256 proposalId)
    external
    view
    override
    returns (bool)
   ...
   * @return voting power needed for a proposal to pass
   **/
  function isQuorumValid(IPegasysGovernanceV2 governance, uint256 proposalId)
    public
    view
    override
    returns (bool)
  {
    IPegasysGovernanceV2.ProposalWithoutVotes memory proposal = governance.getProposalById(
      proposalId
    );
   ...
   **/
  function isVoteDifferentialValid(IPegasysGovernanceV2 governance, uint256 proposalId)
    public
    view
    override
    returns (bool)

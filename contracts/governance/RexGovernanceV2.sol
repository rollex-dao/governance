 ...
 * @dev Main point of interaction with Rex protocol's governance
 * - Create a Proposal
 * - Cancel a Proposal
 * - Queue a Proposal
 * - Execute a Proposal
 ...
 * @author Rex
 **/
contract RexGovernanceV2 is Ownable, IRexGovernanceV2 {
  ...
  string public constant NAME = 'Rex Governance v2';
